...
Properties {
	...
	_RandomTexture ("", 2D) = "" {}
	_SSAO("", 2D) = "" {}
	_NoiseScale("", Vector) = (0, 0, 0, 0)
	_CameraDepthNormalsTexture_ST("", Vector) = (0, 0, 0, 0)
	_CameraDepthNormalsTexture("", 2D) = "" {}
	_Params("", Vector) = (0, 0, 0, 0)
}
Subshader {
...
v2f_ao vert_ao (appdata_img v)
{
	...
	o.uvr = v.texcoord.xy * _NoiseScale.xy;
	return o;
}
